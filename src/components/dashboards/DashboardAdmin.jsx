...
// Importar secciones modularizadas
...
export default function DashboardAdmin() {
  ...
  useEffect(() => {
    localStorage.setItem("biblitech_sidebar_collapsed", sidebarCollapsed);
  }, [sidebarCollapsed]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside
        ...
        } bg-white border-r border-gray-200 flex flex-col transition-all duration-300 sticky top-0 h-screen self-start`}
      >
        {/* Logo */}
        <div
        ...
        <nav className="px-3 space-y-1 flex-1 py-4 overflow-y-auto">
          ...
          <button
            ...
            title={sidebarCollapsed ? "Auditorías" : ""}
          >
            <svg
              className="w-[18px] h-[18px]"
              fill="none"
            ...
            >
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-6 py-2.5 bg-[#0071a4] text-white rounded-lg font-medium hover:bg-[#005a85] transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? "Guardando..." : "Guardar"}
                </button>
              </div>
