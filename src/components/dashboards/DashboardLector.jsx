...
import CatalogSection from "../lector/CatalogSection";
import LoansSection from "../lector/LoansSection";
...
export default function DashboardLector() {
      ...
      >
        ...
        <nav className="px-4 py-6 space-y-2 flex-1 overflow-y-auto">
          ...
          <button
            ...
            title={sidebarCollapsed ? "Catálogo" : ""}
          >
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          <button
            ...
            title={sidebarCollapsed ? "Mis Préstamos" : ""}
          >
            <svg
              className="w-5 h-5"
              fill="none"
            ...
            {!sidebarCollapsed && "Mis Préstamos"}
          </button>
        </nav>
      </aside>
      {/* Main Content */}
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  if (response.ok || response.status === 500) {
                    // 500 se maneja silenciosamente porque los datos se guardan
                    setShowProfileModal(false);
                    setProfileError("");
